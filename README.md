...
```
📁 CitiBike Analytics Project
├── 🚀 app.py                          # Main Streamlit dashboard
├── 📋 requirements.txt                # Main dependencies
├── 🔧 backend/                        # Backend services
│   ├── langchain_agent_system.py
│   ├── langchain_api_server.py
│   ├── phoenix_langchain_monitor.py
│   ├── simple_api_server.py
│   ├── simple_langchain_system.py
│   └── visualization_api_server.py
├── 🎨 frontend/                       # Frontend components
│   └── chat_widget.html
├── 📓 notebooks/                      # Jupyter notebooks
│   ├── citibike_charts_working_code.ipynb
│   ├── citibike_improved_analysis.ipynb
│   ├── citibike_keplergl_visualization.ipynb
│   ├── citibike_plotly_charts.ipynb
│   ├── citibike_seaborn_analysis.ipynb
│   └── citibike_weather_analysis_2024.ipynb
├── 📊 data/                          # Data files
│   ├── citibike_trips_map.html
│   ├── citibike_weather_detrended_analysis.csv
│   ├── reduced_data_to_plot_7.csv
│   └── top20.csv
├── ⚙️ config/                        # Configuration files
│   ├── citibike_kepler_config.json
│   ├── config_langchain.py
│   ├── requirements.txt
│   ├── requirements_langchain.txt
│   └── requirements_langchain_simple.txt
├── 🔧 scripts/                       # Utility scripts
│   ├── st_dashboard_Part_2.py
│   ├── start_langchain_system.py
│   ├── start_working_langchain.py
│   └── test_langchain_system.py
├── 📚 docs/                          # Documentation
│   ├── README.md
│   ├── Plan.md
│   └── README_LANGCHAIN.md
...
### 1. 🎨 CitiBike Seaborn Analysis (`notebooks/citibike_seaborn_analysis.ipynb`)
...
### 2. 🌤️ Weather Analysis 2024 (`notebooks/citibike_weather_analysis_2024.ipynb`)
...
### 3. 🔄 Enhanced Weather Analysis (`notebooks/citibike_improved_analysis.ipynb`)
